...
export function buildWhatsAppMessage(a: Answers, d: Diagnosis): string {
  const parts = [
    ...
    line("Site/landing page", a.temSite),
    line("Identidade visual nas redes", a.identidadeVisual),
