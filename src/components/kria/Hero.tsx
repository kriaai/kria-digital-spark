  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
        <div className="grid items-center gap-5 sm:gap-6 lg:gap-10 grid-cols-[130px_1fr] sm:grid-cols-[160px_1fr] md:grid-cols-[200px_1fr] lg:grid-cols-[1fr_1.15fr]">
          <div className="relative">
            ...
            <img
              ...
              className="mx-auto w-full max-w-[130px] object-contain drop-shadow-2xl sm:max-w-[160px] md:max-w-[200px] lg:max-w-md"
            />
          </div>
